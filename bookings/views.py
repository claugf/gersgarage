...
def products(request):
    ...
    return render(request, 'bookings/products.html', {'products': products})
...
def customer(request, pk):
    ...
    return render(request, 'bookings/customer.html', context)
...
def createOrder(request, pk):
    ...
    return render(request, 'bookings/order_form.html', context)
